  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 mt-2">
      ...
      <div className="relative bg-black h-[400px] flex justify-center items-center overflow-visible rounded-lg">
        ...
        <div className="absolute left-10 -bottom-55 w-32 md:w-[180px] z-10 shadow-lg">
          <img
            src={
              movie.poster_url
      ...
      <div className=" md:mt-32 space-y-0 px-1 sm:px-0 ">
        {/* Thông tin phim */}
        <div className="-mt-20 md:pt-0 md:ml-[240px]">
          ...
          <div className="text-sm sm:text-lg text-gray-600 space-y-2">
            ...
            <div className="flex items-center flex-wrap gap-2 mt-1">
              ...
              {movie.genres && movie.genres.length > 0 ? (
                movie.genres.map((genre, index) => (
                  <span
                    key={index}
                    className="bg-gray-200 px-2 py-1 rounded text-base sm:text-sm text-primary-custom"
                  >
                    {genre.genre_name}
                  </span>
                ))
            ...
            <div className="flex items-center flex-wrap gap-2 mt-1">
              ...
              {movie.actor ? (
                movie.actor.split(",").map((actor, index) => (
                  <span
                    key={index}
                    className="bg-gray-200 px-2 py-1 rounded text-lg sm:text-sm text-primary-custom"
                  >
                    {actor.trim()}
                  </span>
                ))
            ...
            <p>
              ...
              <span className="inline-block bg-gray-200 px-2 py-1 rounded text-xs sm:text-sm text-primary-custom">
                {movie.derector}
              </span>
            </p>
          </div>
